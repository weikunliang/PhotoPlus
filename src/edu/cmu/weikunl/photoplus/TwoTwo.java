...
public class TwoTwo extends ActionBarActivity {

	TwoTwoView v;
	private static int RESULT_LOAD_IMAGE = 1;
	
	// boolean variables to check which collage piece the user clicked
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		v = (TwoTwoView)findViewById(R.id.custView);
	}
	...
	// the button pressed for the right piece which replaces the current image with an uploaded image
	public void btnPressedRight(View view){
		isLeft = false;
		v = (TwoTwoView)findViewById(R.id.custView);
		((View)v).buildDrawingCache();
		Intent i = new Intent(
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            if(isLeft){
            	...
            	v.setBitmapRight(resizedBitmap);
            }
        }
