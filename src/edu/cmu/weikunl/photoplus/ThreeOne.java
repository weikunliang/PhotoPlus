...
public class ThreeOne extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		v = (ThreeOneView)findViewById(R.id.custView);
	}
	
	// the button pressed for the top left piece which replaces the current image with an uploaded image
	public void btnPressedTopLeft(View view){
		isTop = true;
		isTopLeft = true;
		v = (ThreeOneView)findViewById(R.id.custView);
	...
	// the button pressed for the top right piece which replaces the current image with an uploaded image
	public void btnPressedTopRight(View view){
		isTop = true;
		isTopLeft = false;
		v = (ThreeOneView)findViewById(R.id.custView);
		((View)v).buildDrawingCache();
	...
	// the button pressed for the bottom piece which replaces the current image with an uploaded image
	public void btnPressedBot(View view){
		isTop = false;
		Intent i = new Intent(
				Intent.ACTION_PICK, android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            if(isTop && isTopLeft){
            	v.setBitmapTopLeft(resizedBitmap);
            } else if (isTop && !isTopLeft){
            	v.setBitmapTopRight(resizedBitmap);
            } else {
            	v.setBitmapBot(resizedBitmap);
            }
        }
